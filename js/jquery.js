...
function displayAllCategory() {
    for (var category in Groupedproducts) {
        if (Groupedproducts.hasOwnProperty(category)) {
            ...
            $("#cbForm").append('<label class="cbLable"><input id="test" checked class="checkbox categorycheckbox" type="checkbox" value="' + category + '" name="' + category + '"> <p> ' + category + '</p><br></label>');
        }
    }
}
...
function displayAllProducts() {
    for (var category in Groupedproducts) {
        if (Groupedproducts.hasOwnProperty(category)) {
            ...
            $('#products-wraper').append('<div class="inner-bg"><h1>' + category + '</h1></div>');
            ...
            for (a = 0; a < Groupedproducts[category].length; a++) {
                ...
                $('#products-wraper').append('<div class="inner-item"> \
...
$(".categorycheckbox").on("click", clickfu);
...
// var onclickCheckboxFunction = $(".checkbox"); // <- this gives you  a HTMLCollection 
...
function productsearch() {
    ...
    if (resultfound == false) {
        $('#products-wraper').html("<div class='notFoundText'><h1>Not Found</h1></div>");
    }
}
...
function addToCart(selectedItems) {
    ...
    $('#cart').html('<i class="fa fa-shopping-cart"></i><span class="badge">' + cartItems.length + '</span>');
...
if (parse == null) {
    $('#cart').html('<i class="fa fa-shopping-cart"></i><span class="badge">0</span>');
}
if (parse) {
    for (i = 0; i < parse.length; i++) {
        $('#cart').html('<i class="fa fa-shopping-cart"></i><span class="badge">' + parse.length + '</span>');
    }
}
